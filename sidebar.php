...
<!-- Sidebar -->
<aside id="sidebar" class="bg-gradient-to-b from-[#0a1628] via-[#0f2460] to-[#1740b0] text-white flex flex-col w-64 [.collapsed-sidebar_&]:w-20 shadow-2xl z-20 flex-shrink-0 border-r border-white/5">
    <!-- Sidebar Header / Logo area -->
    <div id="sidebar-header" class="h-16 flex items-center px-4 border-b border-white/10 justify-between [.collapsed-sidebar_&]:justify-center">
        <span id="sidebar-brand" class="font-black text-xl whitespace-nowrap overflow-hidden opacity-100 w-auto [.collapsed-sidebar_&]:opacity-0 [.collapsed-sidebar_&]:w-0 text-white tracking-tighter italic font-display">EVAL<span class="text-blue-400">.</span></span>
        <button id="sidebar-toggle" class="text-blue-200/60 hover:text-white focus:outline-none transition-colors p-1 rounded-md hover:bg-white/10">
    ...
    <nav class="flex-1 py-4 space-y-2 overflow-y-auto overflow-x-hidden flex flex-col">
        ...
        <!-- Upload (index.php) -->
        <a href="index.php" class="flex items-center px-4 py-3 group <?php echo ($current_page == 'index.php') ? 'bg-white/10 border-l-4 border-blue-400 text-white shadow-lg' : 'text-blue-100/60 hover:bg-white/5 hover:text-white border-l-4 border-transparent'; ?> transition-all duration-200" title="Upload">
        ...
        <!-- Records (history.php) -->
        <a href="history.php" class="flex items-center px-4 py-3 group <?php echo ($current_page == 'history.php') ? 'bg-white/10 border-l-4 border-blue-400 text-white shadow-lg' : 'text-blue-100/60 hover:bg-white/5 hover:text-white border-l-4 border-transparent'; ?> transition-all duration-200" title="Records">
        ...
        <a href="preview.php" class="flex items-center px-4 py-3 group bg-white/10 border-l-4 border-blue-400 text-white shadow-lg transition-all duration-200" title="Dashboard">
        ...
        <a href="settings.php" class="flex items-center px-4 py-3 group <?php echo ($current_page == 'settings.php') ? 'bg-white/10 border-l-4 border-blue-400 text-white shadow-lg' : 'text-blue-100/60 hover:bg-white/5 hover:text-white border-l-4 border-transparent'; ?> transition-all duration-200" title="Settings">
