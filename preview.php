        ...
        <div id="dashboard-content"
            ...
            <div id="dashboard-visuals" class="mb-10 grid grid-cols-1 lg:grid-cols-3 gap-6 hidden">
                <div class="space-y-6 lg:col-span-1">
                    ...
                    <div
                        class="bg-green-50 p-6 rounded-lg border border-green-200 shadow-sm flex flex-col items-center justify-center h-32">
                        <p class="text-sm font-semibold text-green-800 uppercase text-center mb-2">Overall Satisfaction
                        </p>
                        <p id="kpi-satisfaction" class="text-3xl font-bold text-green-900">-</p>
                    </div>
                    <div
                        class="bg-amber-50 p-6 rounded-lg border border-amber-200 shadow-sm flex flex-col items-center justify-center h-32">
                ...
                <div
                    class="lg:col-span-2 bg-white p-4 rounded-lg border border-gray-200 shadow-sm min-h-[300px] relative">
